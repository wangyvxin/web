...
! function (a, b) {
    function g(b, c) {
        this.element = b, this.settings = a.extend({}, f, c), this._defaults = f, this._name = e, this.version = "v1.2.0", this.init()
    }
    var e = "sliphover",
        f = {
            target: "img",
    ...
    g.prototype = {
        init: function () {
            ...
            a(this.element).off("mouseenter.sliphover", c).on("mouseenter.sliphover", c, function (c) {
                var d = a(c.target),
